...
namespace Taimer
{
    public partial class TestEN : Form
    {
        ...
        Actividad_p activ1 = new Actividad_p("Actividad Test", "Descripción", new User("Usuario", "12345678X", "usuario@user.com", "fechadenacimiento", 3, "Ingeniería de Magisterio Infantil",0));
        ...
        {
            Actividad_a activa1 = new Actividad_a("Actividad A 1", "Descripción", "A saber", "II");
            Actividad_a activa2 = new Actividad_a("Actividad A 2", "Descripción", "A saber", "II");
            Actividad_a activa3 = new Actividad_a("Actividad A 3", "Descripción", "A saber", "II");

            Actividad_p activp1 = new Actividad_p("Actividad P 1", "Descripción", usuario);
            Actividad_p activp2 = new Actividad_p("Actividad P 2", "Descripción", usuario);
            Actividad_p activp3 = new Actividad_p("Actividad P 3", "Descripción", usuario);
        }
