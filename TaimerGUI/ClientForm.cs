...
namespace TaimerGUI {
    public partial class ClientForm : Form {
        ...
        private User generateUserDebug() {
            ...
            Actividad_p actP = new Actividad_p("P1", "Asignatura P1 que descripcion 1", usertest);
            actP.AddTurno(t1);

            Actividad_p actP2 = new Actividad_p("P2", "Otra cosa muy distinta a la uno", usertest);
            actP2.AddTurno(t4);
            actP2.AddTurno(t5);
            actP2.AddTurno(t6);
            ...
            Actividad_a actA = new Actividad_a("A1", "descripcion2", "Un profesor", "II");
            actA.AddTurno(t2);
            actA.AddTurno(t3);

            Actividad_a actA2 = new Actividad_a("A2", "descripcion2", "Otro profesor", "II");
            actA2.AddTurno(t7);
            //actA2.AddTurno(t8);
            actA2.AddTurno(t9);
